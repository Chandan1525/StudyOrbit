...
import { ArrowRight, Lock, EyeOff, Eye, ArrowLeft, ShieldCheck, Loader2, Check } from "lucide-react";
...
export default function ChangePasswordPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.put(
        `${process.env.NEXT_PUBLIC_BACKEND_URL || "http://localhost:5000"}/api/users/change-password`,
      ...
      // Auto redirect to settings after 2.5s
      setTimeout(() => {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-white flex items-center justify-center px-6">
      ...
      >
        <div
          className="relative rounded-[28px] p-8 md:p-10 shadow-2xl overflow-hidden"
          style={{
        ...
        >
          ...
          {step === "reset" && (
            ...
            >
              <h2 className="text-xl font-bold text-white text-center mb-2">Change Password</h2>
              ...
              {error && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="rounded-2xl px-4 py-3 text-sm text-center font-medium mb-6"
              ...
              <div className="space-y-5">
                      ...
                      <div className="flex gap-1.5 mb-1.5">
                        {[1, 2, 3, 4, 5].map((bar) => (
                          <div key={bar} className="flex-1 h-1 rounded-full transition-all duration-300"
                            style={{ background: bar <= strength.score ? strength.color : "rgba(255,255,255,0.08)" }}
                          />
                        ))}
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-xs" style={{ color: "rgba(255,255,255,0.3)" }}>Password strength</span>
                ...
                <motion.button
                  ...
                  className="w-full py-4 rounded-2xl font-bold text-sm text-white flex items-center justify-center gap-2 mt-4 disabled:opacity-70 disabled:cursor-not-allowed"
                  style={{
          ...
          {step === "success" && (
            ...
            >
              ...
              <p className="text-sm mb-6" style={{ color: "#7a5a5e" }}>
          ...
          {step === "reset" && (
            <div className="mt-8 text-center">
              <button
                ...
                style={{ color: "#5a3a3e" }}
                onMouseEnter={(e) => { (e.currentTarget as HTMLButtonElement).style.color = "#e05070"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLButtonElement).style.color = "#5a3a3e"; }}
              >
