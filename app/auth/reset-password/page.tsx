    ...
    for (let i = 0; i < 14; i++) {
      ...
      for (let s = 0; s <= 100; s++) {
        ...
        const rotY =
          ...
          ry * Math.sin(theta) * Math.cos(angle);
        s === 0
          ? ctx.moveTo(cx2 + rotX, cy2 + rotY)
          : ctx.lineTo(cx2 + rotX, cy2 + rotY);
      }
      ctx.closePath();
              ...
              <div>
                ...
                {confirmPassword.length > 0 && (
                  <p
                    ...
                    style={{
                      color:
                        confirmPassword === newPassword ? "#22c55e" : "#e05070",
                    }}
                  >
                    {confirmPassword === newPassword
                      ? "✓ Passwords match"
        ...
        {step === "reset" && (
          <div className="mt-8 text-center">
            <Link
              ...
              style={{ color: "#5a3a3e" }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.color = "#e05070";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.color = "#5a3a3e";
              }}
            >
